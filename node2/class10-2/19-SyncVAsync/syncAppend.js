// This file is written in this funny way so you can better visualize
// how Node's asynchronous pattern works.
...
fs.readFile('written.txt', 'utf8', function (err) {
  ...
  console.log(number);
  let secondNumber = 0;
  // Inside of the readFile callback, we use the appendFileSync function.
  // This version of appendFile is synchronous.
